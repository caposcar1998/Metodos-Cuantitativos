...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        Double[] testChi = {
                0.411,0.11,0.191,0.037,0.92,0.575,0.93,
                0.281,0.408,0.541,0.995,0.233,0.553,0.99,
                0.81,0.598,0.434,0.668,0.119,0.791,0.93,
                0.77,0.671,0.156,0.383,0.711,0.914,0.826,0.98,0.984
        };
